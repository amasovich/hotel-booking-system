 ...
 *
 * <p>
 * Важный нюанс: ошибки аутентификации/авторизации обрабатываются внутри filter chain
 * (AuthenticationEntryPoint / AccessDeniedHandler), поэтому {@code @RestControllerAdvice}
 * может не получить управление.
 * </p>
 */
